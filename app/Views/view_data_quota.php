...
$strquery = "SELECT *,CONCAT(NWB_ID_PROJ,';',NWB_Quota) as GAB, MAX(Target) as MaxTarget FROM tb_target WHERE NWB_10digit LIKE '$vsimponi' AND  NWB_IDTARGET LIKE '$vnamaproj'  GROUP BY NWB_Quota,NWB_IDTARGET";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota1) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi' AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota1";
$bantu01 = mysqli_query($conn, $strquery);
$quota1 = [];
$row = [];
while ($row = mysqli_fetch_assoc($bantu01)) {
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota2) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi' AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota2";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota3) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi'  AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota3";
//$strquery="SELECT *,SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_10digit LIKE '$vsimponi' GROUP BY NWB_Quota3";
$bantu01 = mysqli_query($conn, $strquery);
$quota3 = [];
$row = [];
while ($row = mysqli_fetch_assoc($bantu01)) {
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota4) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi'  AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota4";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota5) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi'  AND  NWB_ID LIKE '$vnamaproj' GROUP BY NWB_Quota5";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota6) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi' AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota6";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota7) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi'  AND  NWB_ID LIKE '$vnamaproj' GROUP BY NWB_Quota7";
...
$strquery = "SELECT *,CONCAT(NWB_IDPROJ,';',NWB_Quota8) as GAB, SUM(NWB_Num) as SUMACH,MIN(NWB_StartDate) as NWB_StartDate,MAX(NWB_StartDate) as NWB_EndDate  FROM tb_NWB WHERE NWB_STATUS LIKE 'Complete' AND NWB_10digit LIKE '$vsimponi' AND  NWB_ID LIKE '$vnamaproj'  GROUP BY NWB_Quota8";
