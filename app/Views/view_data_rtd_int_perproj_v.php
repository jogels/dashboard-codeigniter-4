...
$strquery="SELECT * FROM tb_Project_ownership GROUP BY PROJ_Symphoni_num" ;
...
$strquery="SELECT *, SUM(NWB_Num) as SUMACH FROM tb_NWB  WHERE NWB_STATUS LIKE 'Complete' GROUP BY NWB_INT,NWB_12digit" ;
$bantu01=mysqli_query($conn,$strquery); 
$arrayint=[];
while ($row = mysqli_fetch_assoc($bantu01)) {
       $arrayint[]=$row;
...
foreach($tb_all as $row){
    if($row['stat_internal']=='vendor'){
        ...
        $tb_all_vendor[]=$arbantu0;
    }
}
//print_r($tb_all);
// die();
$columns = array_column($tb_all_vendor, "id_int");
array_multisort($columns, SORT_ASC, $tb_all_vendor);
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <!--<li class="menu-header">RTD</li>-->
                                    <!--<ul class="dropdown-submenu">-->
                                        ...
                                        <li><a class="nav-link" href="<?php echo site_url('/db_rtd_int_perproj') ?>">LIST PROJ BY INTV</a></li>
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>LIST OF PROJECT (VENDOR INTERVW) <br>
            </h1><br>
        </div>
 ...
 <tbody>
                            				    <?php $i=1;?> 
                            				    <?php foreach($tb_all_vendor as $row){ 
                                				   $i=$i+1 ?> 
