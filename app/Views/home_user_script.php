...
////==========final 
$strquery = "SELECT *,AVG(PROJ_Target) as Sum_Target, MIN(PROJ_Field_start) as minPROJ_Field_start,MAX(PROJ_Field_End) as maxPROJ_Field_End FROM tb_Project_ownership WHERE PROJ_Status_DP=1 or PROJ_StatusFieldFinal = 1 GROUP BY PROJ_Symphoni_num,PROJ_KODENWB";
$bantu01 = mysqli_query($conn, $strquery);
$SummPROJ = [];
$row = [];
$bantu = [];
...
<div id="div_refresh">
    ...
    <div class="main-content">
        <section class="section">
            ...
            <?php $session = session() ?>
            <h4>Selamat datang <?php echo $session->get('username') ?> (Anda sebagai User) - <strong>LIST OF ACTIVE PROJECTS - SCRIPTING</strong></h4>
                        ...
                        <!-- <a href="<?= site_url('add') ?>" class="btn btn-primary mb-3">Add Data</a> -->
                         <table border="1" cellpadding="3" cellspacing="0" width=100% style='border-collapse:collapse; table-layout:absolute ; font-size:11px'>
                            ...
                            <tbody>
                                ...
                                if(strtolower(trim(substr($row['Status'], 3, 50)))=='dp:scripting'){ 
                                ?>
